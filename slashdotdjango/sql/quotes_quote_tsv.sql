...
create trigger t_tsvector_update_trigger before insert or update on quotes for each row execute procedure tsvector_update_trigger(quote_tsv, 'pg_catalog.english', quote);
