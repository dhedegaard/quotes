...
DATABASES = {
    'default': {
        ...
        'NAME': 'slashdot',                      # Or path to database file if using sqlite3.
        'USER': 'slashdot',                      # Not used with sqlite3.
        'PASSWORD': 'slashdot123',                  # Not used with sqlite3.
...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'NAME': os.path.join(PROJECTDIR, 'quotes.db'),
        }
    }
...
STATIC_ROOT = os.path.join(PROJECTDIR, 'static_gather')
...
SECRET_KEY = '9jpecg32p9g*wxt+afbl1ti=-r8qzsd7*leo9k^vyu$n!ra1b3'
